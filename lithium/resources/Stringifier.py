class Stringifier:
    ...
    def stringify(self, ast: dict) -> str:
        ...
        try:
            ...
            self.eh.throw("outdatedStringifier", f"stringifier does not recognize ast token {ast['type']!r}.\nperhaps your stringifier is outdated?")
    ...
    def stringifyLine(self, ast: dict) -> str:
        return self.interpreter.lithium.source.splitlines()[ast["span"]["line"]]
    ...
    def interpretData(self, ast: dict) -> dict:
